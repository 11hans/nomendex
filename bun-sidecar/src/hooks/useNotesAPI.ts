...
export const notesAPI = {
    ...
    resolveNote: (args: { name: string }) => fetchAPI<{ fileName: string } | null>("resolve", args),
    ...
    removeTagFromIndex: (args: { tagName: string; sourcePrefix?: string }) => fetchAPI<{ success: boolean }>("tags/remove-from-index", args),
    removeTagFromAllNotes: (args: { tagName: string }) => fetchAPI<{ notesUpdated: number }>("tags/remove-from-all-notes", args),
